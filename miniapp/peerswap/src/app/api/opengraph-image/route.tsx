  ...
  return new ImageResponse(
    (
      <div tw="flex h-full w-full flex-col justify-center items-center relative bg-primary">
        ...
        <h1 tw="text-8xl text-white">{user?.display_name ? `Welcome to PeerSwap, ${user.display_name ?? user.username}!` : 'Welcome to PeerSwap!'}</h1>
        <p tw="text-5xl mt-4 text-white opacity-80">P2P Cross-Chain Token Swaps 🔄</p>
      </div>
    ),
    {
      width: 1200,
