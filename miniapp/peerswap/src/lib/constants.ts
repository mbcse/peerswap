 ...
 */
export const APP_NAME = 'peerswap';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'P2P cross-chain swap platform';
 ...
 */
export const APP_TAGS = ['peerswap', 'defi', 'cross-chain', 'p2p', 'swaps'];
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  header: "eyJmaWQiOjcyNTkwMywidHlwZSI6ImF1dGgiLCJrZXkiOiIweEREMzljMGMzOTg0OTUyRURhOTg3NDAzMjlEZjEyYUZkRGIzMEI2OGIifQ",
  payload: "eyJkb21haW4iOiJwZWVyc3dhcC52ZXJjZWwuYXBwIn0",
  signature: "2qIo+0w2hHYLLogmMk2emOmZjjz4BFmomONY+PpYUfJuIdJZRwueS3lcLnsoLk/g7O6bmb89SmgzAAVMbx+v0Rs="
};
 ...
 */
export const APP_BUTTON_TEXT = 'START PEER SWAP';
