  ...
  return (
    <div className="space-y-3 px-6 w-full max-w-md mx-auto">
      ...
      <div className="card p-3">
        <div className="text-sm mb-2">PeerSwap</div>
        <div className="grid grid-cols-2 gap-2">
          <Button onClick={() => router.push("/create-swap")}>
            Create Swap
          </Button>
          <Button onClick={() => router.push("/fulfill-swap")}>
            Fulfill Swap
          </Button>
        </div>
        <div className="mt-2">
          <Button onClick={() => router.push("/initialize-source")}>Initialize Source</Button>
        </div>
        <div className="mt-2">
          <Button
            variant="outline"
